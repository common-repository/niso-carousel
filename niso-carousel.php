 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Niso Carousel
 * Plugin URI:        http://wpthemespace.com
 * Description:       A simple carousel plugin.You can create lots of carousel and simple slider by this plugin.
 * Version:           1.1.3
 * Author:            Noor alam
...
require_once (NISO_CAROUSEL_SLIDER_DIR . 'admin/src/cmb-field-select2/cmb-field-select2.php');
...
wp_enqueue_style( 'niso-carousel-admin', plugins_url( '/assets/css/admin.css', __FILE__ ), array(), '1.0', 'all');


wp_enqueue_script( 'niso-carousel-labelauty', plugins_url( '/assets/js/jquery-labelauty.js', __FILE__ ), array( 'jquery' ), '1.0', true);
wp_enqueue_script( 'niso-carousel-admin', plugins_url( '/assets/js/niso-admin.js', __FILE__ ), array( 'jquery' ), '1.0', true);
}
