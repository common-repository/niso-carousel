...
function niso_slider_carousel_group_tab() {
	...
	$images_carousel2 = $niso_meta->add_field( array(
		...
		'type'         => 'group',
		'repeatable'   => true,
		'before_group' => '<div class="tab-content niso-caption" id="tab-2">',
		'after_group'  => '</div>',
		'options'      => array(
	...
	$niso_meta->add_group_field( $carousel_settings, array(
		...
		'id'      => 'niso_margin_use',
		'type'        => 'radio_inline',
		'default'     => 'margin_yes', // default value
		'options'     =>array(
			'margin_yes'        => 'Yes',
			'margin_no'        => 'No',
		),
	...
	$pro_carousel = $niso_meta->add_field( array(
		'id'           => 'niso_pro',
		'type'         => 'group',
		'repeatable'   => false,
		'before_group' => '<div class="tab-content tab-pro" id="tab-5">',
		'after_group'  => '</div>',
		'options'      => array(
	...
	$niso_meta->add_group_field( $pro_carousel, array(
		'name'       => __( 'Niso Carousel', 'gbox' ),
        'desc'       => __( ' 
        <div class="niso-prolink"> 
            ...
            <a class="button button-primary" href="https://wpthemespace.com/product/niso-carousel/" target="_blank">View details</a>
        </div>
	...
	$niso_meta->add_field( array(
		'desc' => '<a class="button button-primary button-large" class="doc" href="http://plugin.wpthemespace.com/niso-doc/" target="_blank" />Niso carousel documentation</a>',
		'id'   => 'awesome_doc',
		'type' => 'text',
	) );
